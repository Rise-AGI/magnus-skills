"""
Figure 6: Effect of noise on adiabatic preparation - Zd model.
...
print("Data saved to ../data/fig6_noise_zd.csv")
...
ax.set_title(r'$Z_d$ model: Effect of noise')
ax.legend()
ax.set_xscale('log')
ax.set_yscale('log')
...
plt.tight_layout()
plt.savefig('../plots/fig6_noise_zd.png', dpi=150, bbox_inches='tight')
print("Plot saved to ../plots/fig6_noise_zd.png")
