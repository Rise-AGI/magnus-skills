"""
Figure 3: Split-Step soliton collision, S=-0.1, v1=10, v2=-10
...
ax.set_title('Split-Step: S=-0.1, v1=10, v2=-10')
fig.colorbar(surf, shrink=0.5, aspect=10)
plt.tight_layout()
plt.savefig('../plots/fig3_ss_small_neg_v10.png', dpi=150)
plt.close()

with open('../data/fig3_ss_small_neg_v10.csv', 'w') as f:
    f.write('# Split-Step soliton collision: S=-0.1, v1=10, v2=-10\n')
...
print("Figure 3 done: Split-Step S=-0.1, v=+/-10")
